...
class Dependencies {
	...
	public function check() {
		$this->loader->add_action( 'wp_ajax_cptwooint_plugin_activation', $this, 'activate_plugin' );
		$this->loader->add_action( 'admin_enqueue_scripts', $this, 'admin_notice_scripts' );
		$this->loader->add_action( 'admin_print_styles', $this, 'admin_print_styles' );
		$this->loader->add_action( 'admin_print_footer_scripts', $this, 'admin_print_footer_scripts' );

		if ( version_compare( PHP_VERSION, self::MINIMUM_PHP_VERSION, '<' ) ) {
			$this->loader->add_action( 'admin_notices', $this, 'minimum_php_version' );
			$this->allOk = false;
		}
		...
		if ( ! empty( $this->missing ) ) {
			$this->loader->add_action( 'admin_notices', $this, '_missing_plugins_warning' );
