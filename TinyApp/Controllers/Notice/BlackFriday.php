...
class BlackFriday {
	...
	private function black_friday_notice() {
		$this->loader->add_action( 'admin_enqueue_scripts', $this, 'black_friday_scripts' );
		$this->loader->add_action( 'admin_notices', $this, 'admin_notices_style' );
		$this->loader->add_action( 'admin_footer', $this, 'admin_footer_scripts' );
		$this->loader->add_action( 'wp_ajax_cptwooint_dismiss_bf_admin_notice', $this, 'dismiss_bf_admin_notic' );
	}
	/**
	 * @return void
	 */
	public function black_friday_scripts() {
		wp_enqueue_script( 'jquery' );
	}
	/**
	 * @return void
	 */
	public function admin_notices_style() {
		?>
		<style>
			.cptwooint-bf-notice {
	 ...
	 * @return void
	 */
	public function dismiss_bf_admin_notic() {
