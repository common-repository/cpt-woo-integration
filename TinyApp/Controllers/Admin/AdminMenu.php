...
class AdminMenu {
	...
	public function register_admin_menu() {
		...
		add_submenu_page(
			self::MENU_PAGE_SLUG,
			esc_html__( 'WC Integration', 'cptwooint' ),
			'<span class="cptwooint-is-submenu" ><span class="dashicons dashicons-arrow-right-alt" ></span>' . esc_html__( 'WC Integration', 'cptwooint' ) . '</span>',
			self::MENU_CAPABILITY,
			self::MENU_PAGE_SLUG,
		);
		...
		add_submenu_page(
			self::MENU_PAGE_SLUG,
			esc_html__( 'Short Code', 'cptwooint' ),
			'<span class="cptwooint-is-submenu" ><span class="dashicons dashicons-arrow-right-alt" ></span>' . esc_html__( 'Short Code', 'cptwooint' ) . '</span>',
			self::MENU_CAPABILITY,
			$menu_link_part . '#/shortcode'
		);
		add_submenu_page(
			self::MENU_PAGE_SLUG,
			esc_html__( 'Styles', 'cptwooint' ),
			'<span class="cptwooint-is-submenu" ><span class="dashicons dashicons-arrow-right-alt" ></span>' . esc_html__( 'Styles', 'cptwooint' ) . '</span>',
			self::MENU_CAPABILITY,
			$menu_link_part . '#/styles'
		);
		add_submenu_page(
			self::MENU_PAGE_SLUG,
			esc_html__( 'Useful Plugins', 'cptwooint' ),
			'<span class="cptwooint-is-submenu" ><span class="dashicons dashicons-arrow-right-alt" ></span>' . esc_html__( 'Useful Plugins', 'cptwooint' ) . '</span>',
			self::MENU_CAPABILITY,
			$menu_link_part . '#/plugins'
		);
		add_submenu_page(
			self::MENU_PAGE_SLUG,
			esc_html__( 'Contacts Support', 'cptwooint' ),
			'<span class="cptwooint-is-submenu" ><span class="dashicons dashicons-arrow-right-alt" ></span>' . esc_html__( 'Contacts Support', 'cptwooint' ) . '</span>',
			self::MENU_CAPABILITY,
					...
					<header id="header" class="card clearfix" >
						<div class="product-header">
							<div class="product-icon">
								<img src="https://www.wptinysolutions.com/wp-content/uploads/2024/06/cpt-woo-integration-icon-256x256-1.gif" alt="">
							</div>
